...
2. 이 인코더로 초기화한 **멀티태스크 1D U-Net**이 4-class 분류(정상/심방세동/서맥/빈맥)와 이상 구간 segmentation을 동시에 수행
...
![Transformers](https://img.shields.io/badge/Transformers_(BioBERT)-FFD21E.svg?style=for-the-badge&logo=huggingface&logoColor=black)
